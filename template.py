...
list_of_files = [
    ...
    "terraform/modules/ec2/prometheus/main.tf",
    "terraform/modules/ec2/prometheus/variables.tf",
    "terraform/modules/ec2/prometheus/outputs.tf",
    "terraform/modules/ec2/grafana/main.tf",
    "terraform/modules/ec2/grafana/variables.tf",
    "terraform/modules/ec2/grafana/outputs.tf",
